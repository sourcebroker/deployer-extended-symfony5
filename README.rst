...
deployer-extended-symfony5
==========================

    .. image:: https://img.shields.io/badge/license-MIT-blue.svg?style=flat
       :target: https://packagist.org/packages/sourcebroker/deployer-extended-symfony5
...
This package provides deploy task for deploying Symfony5 with deployer (deployer.org).
...
1) Install with composer:
   ::
      ...
      composer require sourcebroker/deployer-extended-symfony5
...
4) Remove task "deploy" from your deploy.php. Otherwise you will overwrite deploy task defined in
   vendor/SourceBroker/deployer-extended-symfony5/deployer/deploy/task/deploy.php
